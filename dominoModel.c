...
bool jogadaJogador2(int a, int b, bool computador){ //jogador 2 jogando //parâmetro computador para verrificar se é o computador jogando
    bool jogou = false;
